...
export default function Terbaik() {
  ...
  const fetchDataFilm = async () => {
    try {
      const responseFilm = await axios.get("http://localhost:3080/terbaikmov");
  ...
  const fetchDataSeries = async () => {
    try {
      const responseSeries = await axios.get("http://localhost:3080/terbaikser");
  ...
  const fetchDataAnime = async () => {
    try {
      const responseAnime = await axios.get("http://localhost:3080/terbaikani");
